...
| 使う収録ファイル | 基本の紙上経路では[架空のテレビ会議文字起こし](sample-data/video_meeting_transcript.md)、[照合用メモ](sample-data/video_meeting_verification_notes.md)、[誤りを含むAI議事録案](sample-outputs/video_meeting_ai_minutes_problem.md)を使う |
| 成果物 | 主張と出典の記録、判定、修正文、確認日をまとめた`05_ファクトチェック記録.md` |
| 開始条件 | 下の3経路から1つを選び、入力データ、保存場所、確認に使う原文を特定できている |
| 停止条件 | 実在する非公開情報を入力しそう、一次情報を開けない、対象・日付・適用範囲が不明、高リスクな個別判断が必要 |
...
| AIなし | 上記の収録済み文字起こし、照合用メモ、問題のあるAI議事録案を開き、原文照合を紙上またはMarkdownで行う |
...
| 組織利用 | 承認済みアカウントとブラウザだけを使います。検索・履歴・共有・ファイル添付の設定は組織の管理者による案内を優先します。 |
| 未承認・登録不可 | [架空のテレビ会議文字起こし](sample-data/video_meeting_transcript.md)、[照合用メモ](sample-data/video_meeting_verification_notes.md)、[誤りを含むAI議事録案](sample-outputs/video_meeting_ai_minutes_problem.md)を使い、紙上で同じ照合を行います。 |
