...
| 使う収録ファイル | 基本練習は本章内の架空チラシ設定を使う。AIなしでガバナンス判断も練習する場合は[架空の業務改善依頼](sample-data/business_interview_initial_request.md)と[保存済みの架空回答](sample-outputs/business_interview_saved_responses.md)を使う |
| 成果物 | 非公開のチラシ案、制作記録、公開前リスク記録をまとめた`06_公開前レビュー.md` |
| 開始条件 | 下の3経路から1つを選び、利用する素材の出所と成果物の非公開保存場所を決めている |
| 停止条件 | 実在人物・作品・ブランドを使いそう、素材の利用条件が不明、AIが未確認の実績や数字を追加、個別の法的判断が必要 |
...
| AIなし | 本章の架空設定から文章とワイヤーフレームを手で作る。ガバナンスの追加練習には上記の収録済み依頼文と回答を使う |
...
| 未承認・登録不可 | 本章の架空設定と自己点検ガイドのワイヤーフレーム例を使い、文章・画像の指示案と公開前レビューを紙上で行います。追加のガバナンス判断には[架空の業務改善依頼](sample-data/business_interview_initial_request.md)と[保存済みの架空回答](sample-outputs/business_interview_saved_responses.md)を使います。 |
