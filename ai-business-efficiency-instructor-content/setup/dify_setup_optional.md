...
| 紙上代替 | ブラウザ登録、インストール、APIキーが不要 | 推奨代替。すべての受講者が実施可能 |
...
| 企業研修 | 管理者が承認したワークスペース、アカウント、モデル、データ範囲だけを使う |
| Cloud版は承認済みだがモデルが未設定 | 無断でAPIキーや有料モデルを追加せず、管理者へ確認する |
| 利用可否不明・登録不可・認証情報なし | APIキー不要の紙上代替へ切り替える |

企業研修では、講師が個人アカウント作成、クレジット購入、試用開始、外部モデル契約を受講者へ求めません。
...
3. 次のような完全な架空FAQだけを知識データとして登録します。
